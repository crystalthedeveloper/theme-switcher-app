const en = {
    ...
    metaDescription: 'Theme Switcher',
    description: 'The Theme Switcher allows your visitors to switch between dark and light mode on your Webflow site without any coding required.',
    buttonInstall: 'Install Theme Switcher',
    ...
    success: {
        ...
        description: 'The Theme Switcher has been installed on your Webflow site.',
        buttonHome: 'Home',
        buttonWebflowDashboard: 'Webflow Dashboard',
        webflowDashboardAriaLabel: 'Open Webflow Dashboard',
        homeAriaLabel: 'Go back to homepage',
    },
