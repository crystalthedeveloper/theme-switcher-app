...
export default function Home() {
  ...
  const authURL = `https://webflow.com/oauth/authorize?client_id=${clientId}&response_type=code&scope=custom_code:read custom_code:write sites:read sites:write pages:read pages:write authorized_user:read workspaces:read&prompt=consent&include=authorized_user&include=site${redirectUri ? `&redirect_uri=${encodeURIComponent(redirectUri)}` : ''}`;
